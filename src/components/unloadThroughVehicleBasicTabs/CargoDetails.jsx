...
const CargoDetails = ({ viewVehicleList }) => {
    ...
    useEffect(() => {
        ...
        console.log(viewVehicleList?.cargo_detail);
                    ...
                    {!isData ? (
                        ...
                        <div className="" style={{ overflowX: "scroll",width: "100%" }}>
                            <table className="table">
                                <thead>
                                    <tr>
                                        <th style={{width: "max-content"}}>Bags Qty</th>
                                        <th style={{width: ""}}>Bags Weight</th>
                                        <th style={{width: ""}}>Total Weight</th>
                                        <th style={{width: ""}}>Bags Type</th>
